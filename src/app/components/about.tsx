  ...
  return (
    <div className="flex flex-col items-center justify-center p-4 bg-gray-100 w-full lg:w-2/3">
      ...
      <div className="mt-8 mb-4">
        <p className="font-semibold uppercase text-red-500 text-xl">If you answered yes to any of these questions, then this is for you!</p>
      </div>
      <div className="flex flex-col items-center gap-4">
        ...
        <p className="uppercase text-xl font-semibold self-start">Then this business id for you</p>
      </div>
      <div className="mt-8 mb-4">
        <p>Unfortunately this <span className="text-xl uppercase">free training</span> is only available for the first <span className="text-xl">100 people, join now! </span></p>
      </div>
